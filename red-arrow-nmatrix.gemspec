...
require "arrow-nmatrix/version"

Gem::Specification.new do |spec|
  spec.name = "red-arrow-nmatrix"
  spec.version = ArrowNMatrix::VERSION
  spec.homepage = "https://github.com/red-data-tools/red-arrow-nmatrix"
